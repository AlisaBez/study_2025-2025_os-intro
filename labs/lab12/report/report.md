...
Переменная определяется присваиванием: имя=значение. Массив определяется: имя=(элемент1 элемент2). Обращение к переменной: $имя. Обращение к элементу массива: ${имя[индекс]}.
