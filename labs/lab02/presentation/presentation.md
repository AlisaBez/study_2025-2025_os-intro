...
![Конфигурация git](image/1.jpg){#fig:git-config width=70%}

---

Создаю ключ ssh (рис. -@fig:ssh).

![Создание ssh ключа](image/2.jpg){#fig:ssh width=70%}

---

Создаю ключ gpg (Рис -@fig:gpg).

![Создание gpg ключа](image/5.jpg){#fig:gpg width=70%}

---

Получаю ключи и подключаю их к гитхабу  (Рис -@fig:git) 

![подключение ключа](image/3.jpg){#fig:git width=70%}

---

И (Рис. -@fig:gitt) 

![Подключение ключа](image/9.jpg){#fig:gitt width=70%}

---

Настраиваю автоматические подписи (Рис -@fig:006) 

![Подписи для коммитов](image/10.jpg){#fig:006 width=70%}

--- 

Авторизуюсь на гитхаб через терминал (Рис -@fig:007) 

![Авторизация на github](image/11.jpg){#fig:007 width=70%}

---

И (Рис -@fig:008) 

![Авторизация на гитхаб](image/12.jpg){#fig:008 width=70%}

---

Создаю директорию курса через шаблон (Рис.-@fig:009)

![Создание директории курса](image/13.jpg){#fig:009 width=70%}

---

И настраиваю рабочую директорию (Рис. -@fig:010) 

![Настройка директории](image/14.jpg){#fig:010 width=70%}
